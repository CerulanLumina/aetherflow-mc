...
//import net.cerulan.luminality.client.render.beam.BeamRenderer
...
//        BeamRenderer.renderLumusBeam(lumusRedirector.rangeActual.toFloat() - 0.5f + lumusRedirector.offset - scale, null, direction, tickDelta, lumusRedirector.world!!.time, matrixStack, vertexConsumerProvider)
//        matrixStack.pop()
//    }
//
//
